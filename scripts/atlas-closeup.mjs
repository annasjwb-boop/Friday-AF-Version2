// Close-up shot of one atlas model. Usage: node scripts/atlas-closeup.mjs <Label> [port]
...
// Freeze the landmark spin so the gate side faces the camera.
...
const path = `/tmp/atlas-close-${label.toLowerCase()}.png`;
