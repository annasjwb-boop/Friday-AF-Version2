...
import { applyLook, lookToTheme, type SanctuaryLook } from "../sanctuary-c/look";
...
export function HomeStage({
  ...
  return (
    <>
      ...
      <div className="gdc-stage-actions">
        <button
          type="button"
          className="gdc-swap"
        ...
        <button type="button" className="gdc-swap" onClick={onOpenExplore}>
